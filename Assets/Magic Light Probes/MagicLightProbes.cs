...
namespace MagicLightProbes
{
    ...
    public class MagicLightProbes : MonoBehaviour
    {
        ...
        public ExcludingLightsMode excludingLightsMode = ExcludingLightsMode.AllInList;
        ...
        private IEnumerator PrepareScene()
        {
            ...
            if (workflow == Workflow.Advanced)
            {
                ...
                switch (excludingLightsMode)
                {
                    case ExcludingLightsMode.AllInList:
                        ...
                        break;
                    case ExcludingLightsMode.AllExceptInList:
                        List<MLPLight> tmpLightList = new List<MLPLight>(lights);
                        
                        for (int i = 0; i < tmpLightList.Count; i++)
                        {
                            if (!excludedLights.Contains(tmpLightList[i]))
                            {
                                lights.Remove(tmpLightList[i]);
                            }
                        }
                        break;
                }
