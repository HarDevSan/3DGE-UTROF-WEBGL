...
public class TextEvent_SequentialAndCollect : MonoBehaviour
{
    ...
    void PrintNextTextAndInvokeAllHasBeenPrintedIfNot()
    {
        ...
        {
            OnAllTextHasBeenPrintedAndReadyToCollect.Invoke();
            ResetAllTextMaxVisibleChars();
        }
    }
    ...
    IEnumerator PrintTextAndSelectNextTextWhenDoneRoutine()
    {
        ...
        //Unpause Time cause printign has been done
        UnPauseTimeScale();
        yield break;
    }
