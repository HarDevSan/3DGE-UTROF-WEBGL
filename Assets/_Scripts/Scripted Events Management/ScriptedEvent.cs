...
public class ScriptedEvent : MonoBehaviour
{
    ...
    * or opens a door. It could be that when pressing the "use" key on a console, the time of day changes. The possibilities are and should endless in a flexible Scripted
    ...
    */
    ...
    /* Serialized events in Unity makes this aspect of development natively acessable, because it propagates the complexity to the editor's hierarchy and inspector, instead
