...
{
    static class SGEShaderGraphResources
    {
        public static string s_ResourceClassName => typeof(SGEShaderGraphResources).FullName;

        public static string s_AssemblyName => typeof(SGEShaderGraphResources).Assembly.FullName.ToString();
