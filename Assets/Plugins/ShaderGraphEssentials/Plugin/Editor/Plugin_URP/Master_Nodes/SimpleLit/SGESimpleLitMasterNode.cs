...
namespace ShaderGraphEssentials
{
    ...
    class SGESimpleLitMasterNode : MasterNode<ISGESimpleLitSubShader>, IMayRequirePosition, IMayRequireNormal, IMayRequireTangent
    {
        ...
        public const int VertNormalSlotId = 9;
        public const int VertTangentSlotId = 10;
